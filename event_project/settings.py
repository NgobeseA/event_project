...
SECRET_KEY = 'django-insecure-=m2&#_6$%7n*r64ok%q$#*l*(zjnh=bm#%hy*#8gb-ykd!kvul'
...
ASGI_APPLICATION = 'event_project.asgi.application'
...
DEFAULT_FROM_EMAIL = "andilekngobese@gmail.com"
